...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Settings/Input/InputSettings.inputactions".
/// </summary>
/// <remarks>
...
public partial class @InputSettings: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Game"",
            ""id"": ""2a775596-a087-4133-82e9-a44fe6c204e2"",
            ""actions"": [
                {
                    ""name"": ""Test1"",
                    ""type"": ""Button"",
                    ""id"": ""9a956ede-803b-4803-a1c4-5cac0571d3c2"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""823f06d9-4d77-4d55-988d-c40341e43c6f"",
    ...
    ""controlSchemes"": []
        ...
        m_Game_Test1 = m_Game.FindAction("Test1", throwIfNotFound: true);
    }

    ~@InputSettings()
    {
        UnityEngine.Debug.Assert(!m_Game.enabled, "This will cause a leak and performance issues, InputSettings.Game.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Game_Test1;
    /// <summary>
    ...
    public struct GameActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Game/Test1".
        /// </summary>
        public InputAction @Test1 => m_Wrapper.m_Game_Test1;
        /// <summary>
